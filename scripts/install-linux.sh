#!/usr/bin/env bash
# =============================================================================
# SilentGuard Engine — Linux Installer
...
BINARY_NAME="silentguard-engine-linux"
...
# ─── XDG paths (mirrors engine/config.py) ────────────────────────────────────
...
# Chrome NativeMessaging host directory (per-user, Linux)
CHROME_NMH_DIR="${XDG_CONFIG_HOME}/google-chrome/NativeMessagingHosts"
CHROMIUM_NMH_DIR="${XDG_CONFIG_HOME}/chromium/NativeMessagingHosts"
...
info "SilentGuard Engine Installer — Linux (${VERSION})"
echo ""

# ─── Step 1: Create XDG directory structure ──────────────────────────────────
info "Creating directories following XDG Base Directory Specification..."
